...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    imageFocusM:0.47,            /* Multiplicator for the focussed image size in percent */
	    ...
	    reflectionP: 0.05,            /* Height of the reflection in percent of the source image */
	    reflectionPNG: false,          /* Toggle reflect2.php or reflect3.php */
	    reflectPath: '',             /* Path to the reflect_.php script */
	    scrollbarP: 1,            /* Width of the scrollbar in percent */
	    slider: true,           /* Toggle slider */
	    sliderCursor: 'e-resize',     /* Slider cursor type - default is 'default' */
	    sliderWidth: 100,             /* Width of the slider in px */
